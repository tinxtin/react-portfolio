...
function App() {
    ...
    return (
        <div id='page' className='fixed top-0 left-0 w-dvw h-dvh truncate bg-neutral-950 text-neutral-300 font-body'>
            ...
            <div className='lg:flex lg:justify-between h-screen px-2space'>
                <header id='header' className='lg:flex lg:flex-col py-2space lg:justify-between lg:sticky lg:w-min z-30 lg:max-h-screen' ref={myRef}>
                    <div>
                        <Intro/>
                        <Navbar/>
                    </div>
